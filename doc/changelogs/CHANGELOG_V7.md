...
<a id="7.3.0"></a>
## 2016-12-20, Version 7.3.0 (Current), @italoacasas

### Notable changes

* **crypto**:
  - Allow adding extra certificates to well-known CAs. (Sam Roberts) [#9139](https://github.com/nodejs/node/pull/9139)
* **buffer**:
  - Fix single-character string filling. (Anna Henningsen) [#9837](https://github.com/nodejs/node/pull/9837)
  - Handle UCS2 `.fill()` properly on BE. (Anna Henningsen) [#9837](https://github.com/nodejs/node/pull/9837)
* **url**:
  - Add inspect function to TupleOrigin. (Safia Abdalla) [#10039](https://github.com/nodejs/node/pull/10039)
  -  Including base argument in originFor. (joyeecheung) [#10021](https://github.com/nodejs/node/pull/10021)
  - Improve URLSearchParams spec compliance. (Timothy Gu) [#9484](https://github.com/nodejs/node/pull/9484)
* **http**:
  - Remove stale timeout listeners. (Karl Böhlmark) [#9440](https://github.com/nodejs/node/pull/9440)
* **build**:
  - Fix node_g target. (Daniel Bevenius) [#10153](https://github.com/nodejs/node/pull/10153)
* **fs**:
  - Remove unused argument from copyObject(). (Ethan Arrowood) [#10041](https://github.com/nodejs/node/pull/10041)
* **timers**:
  - Fix handling of cleared immediates. (hveldstra) [#9759](https://github.com/nodejs/node/pull/9759)
* **src**:
  - Add wrapper for process.emitWarning(). (Sam Roberts) [#9139](https://github.com/nodejs/node/pull/9139)
  - Fix string format mistake for 32 bit node. (Alex Newman) [#10082](https://github.com/nodejs/node/pull/10082)
